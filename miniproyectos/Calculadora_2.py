...
def numeroPulsado(num):
   ...
   #Para resetear la pantalla por si hemos pulsado un parametro de operacion
    if operacion !="" or final_operacion == "reseteo":  
        
        numeroPantalla.set(num)
        operacion = ""
          
    elif operacion == "" and numeroPantalla.get() == "0" and num == ".": 
...
def borrado_numero_para_operacion():
...
# -------------------- LECTURA DE NUMERO: FLOAT O INT ------------------- #

def elegirTipoNumero(numero):
   ...
   # global resultado    
    ...
    if comas == TRUE or numeroPantalla.get().count(".") != 0:
        tipoNumero = float(numero)
    else:
        tipoNumero = int(numero)
...
def suma(num):
    ...
    if resultado == 0 or operacion == "resultado":  # Tenemos que hacer esto si no queremos que el primer número que tengamos salga negativo
        resultado = elegirTipoNumero(num)
    else:
        resultado += elegirTipoNumero(num) #Aqui almacenamos el resultado de la cadena de numeros   
...
def multiplicacion(num):
    ...
    numeroFinal = elegirTipoNumero(resultado)
    numeroPantalla.set(str(numeroFinal))
...
def result():
    ...
    if final_operacion == "suma":
        ...
        numeroPantalla.set(str(resultado+elegirTipoNumero(numeroPantalla.get()))) #Asi sumamos lo que hay en la pantalla más lo almacenado hasta el momento
    
    elif final_operacion == "resta":
        numeroPantalla.set(str(resultado-elegirTipoNumero(numeroPantalla.get())))
        ...
        try:
            ...
            numeroFinal = resultado/elegirTipoNumero(numeroPantalla.get())
            numeroPantalla.set(str(numeroFinal))
...
botonBorradoParcial = Button(miFrame, text = "CE", width = 3, bg = "azure3", padx = 10, pady = 10, font=('Arial 12'), command = lambda:borrado_numero_para_operacion())
...
botonBorradoIndividual = Button(miFrame, text = "<<", width = 3, bg = "azure3", padx = 10, pady = 10, font=('Arial 12'), command = lambda:borrado_individual())
